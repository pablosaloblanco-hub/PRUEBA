// ============================================================================
// src/ui/views/TransactionSheet.tsx — STUB (Skeleton phase). Replaced by the sheet
...
export function TransactionSheet() {
  ...
  const titleId = useId()
  const title = sheet.kind.endsWith('/edit') ? copy.transactionSheet.editTitle : copy.transactionSheet.newTitle
