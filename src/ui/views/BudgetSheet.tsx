// ============================================================================
// src/ui/views/BudgetSheet.tsx — STUB (Skeleton phase). Replaced by the sheet
...
export function BudgetSheet() {
  ...
  const titleId = useId()
  const title = sheet.kind.endsWith('/edit') ? copy.budgets.sheetEditTitle : copy.budgets.sheetNewTitle
